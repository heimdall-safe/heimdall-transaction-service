...
MASTER_COPIES: Dict[EthereumNetwork, List[Tuple[str, int, str]]] = {
    EthereumNetwork.MAINNET: [
        ("0x1a976d1fC09D0605eD30eB5c3588deAB1B5A70F7", 4006487, "1.3.0+L2"),
        ("0x1a976d1fC09D0605eD30eB5c3588deAB1B5A70F7", 4006487, "1.3.0"),
    ],
}

PROXY_FACTORIES: Dict[EthereumNetwork, List[Tuple[str, int]]] = {
    EthereumNetwork.MAINNET: [
        ("0xDe197DBB8153752C6305B703DFcb65ABFF93eF6D", 4006781),  # v1.3.0
    ],
}
